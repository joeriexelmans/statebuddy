...
export function AboutStateBuddy({startTrial, setModal}: {startTrial: () => void, setModal: Dispatch<SetStateAction<ReactElement|null>>}) {
  ...
  return <div style={{maxWidth: '500px', padding: 4, display: 'flex', flexDirection: 'column', gap: '1em', alignItems: 'center'}}>
    ...
    <p>StateBuddy is an integrated environment for <a target="_blank" href="https://dl.acm.org/doi/10.1016/0167-6423(87)90035-9">Statechart</a> modeling, simulation, (omniscient) debugging and testing.</p>

    <p>No commercial use without my permission.</p>

    <p>Source code: <a href="https://deemz.org/git/research/statebuddy">Self-hosted</a>, <a href="https://github.com/joeriexelmans/statebuddy">GitHub</a></p>
