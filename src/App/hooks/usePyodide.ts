...
//   const checkProperty = useCallback((property: string, preparedTrace: PreparedTrace) => {
//     return new Promise<PropertyCheckStatus>((resolve) => {
//       withPyodide(pyodide => resolve(getPropertyChecker(pyodide)(property, preparedTrace)));
//     })
//   }, [withPyodide]);
