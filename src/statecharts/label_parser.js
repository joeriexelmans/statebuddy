...
function peg$parse(input, options) {
  ...
  function peg$f11(fieldname, nested_lhs) {
    return [
        fieldname,
        nested_lhs
            ? nested_lhs[3]
  ...
  function peg$f14(variable) {
    return {
        kind: "lhsRef",
        variable,
    };
  }
  function peg$f15(literal) {
    return {
        kind: "lhsLiteral",
        value: literal.value,
    }
  ...
  function peg$f21(operator, atom) {
    if (operator === null) {
       return atom;
    }
    return {
  ...
  function peg$f24(fieldname, expr) {
    return [
        fieldname,
        expr
            ? expr[3]
