...
![and-states and or-states](./images/and_or_states_newsyntax.png)

<!-- ![and-states and or-states (dashed)](./images/and_or_states_newsyntax2.png) -->

AND-states have a white background. OR-states have a grey background.
...
![flat state machine in statebuddy](./images/flat_state_machine.png)
...
![hierarchical state machine in statebuddy](./images/composite_state_newsyntax.png)

This notation deviates from Statecharts literature, where we usually see something like this:

![hierarchical state machine in classic syntax](./images/hierarchy_classic_syntax.png)
...
![orthogonal regions in statebuddy](./images/orthogonal_regions.png)

The border of the OR-states becomes **dashed**, indicating that they are orthogonal.

Note that the orthogonality comes from the fact that the OR-states have an AND-parent. There is nothing intrinsically orthogonal about an OR-state itself.

In Statecharts literature, the above statechart would be drawn as follows:

![classic statechart syntax of orthogonal regions](./images/classic_syntax.png)

Although stylish, StateBuddy does not use dashed lines to divide orthongal regions, because they would be cumbersome to work with. (for the user, and for the parser)
...
![(not entirely) implicit root state](./images/implicit_root.png)
...
![isomorphism between Statecharts and ADTs](./images/isomorphism.png)
...
![itemis syntax for hierarhical states](./images/itemis-syntax-annotated.png)

In StateBuddy, you *can* do the same thing... 

![using itemis syntax in statebuddy](./images/stupid-syntax.png)
...
The most important points are:
 ...
 - You can nest them arbitrarily:
    ...
    - AND within AND: not really useful, you probably want to flatten these

    ![AND-and OR-states can be nested arbitrarily](./images/arbitrary_nesting_newsyntax.png)